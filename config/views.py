...
def home(request):
    ...
    special_article = Article.objects.filter(articleCategory="book").order_by('-pk')[:1] # 기획전 이달의도서 최신 1개

    return render(request, "home/home.html", context={"books": recent_books,
